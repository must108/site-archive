...
export default function Home() {
    ...
    <>
        <div className="h-screen flex items-center justify-center flex-col">
			<p className="font-bold text-lg text-center text-white">hello! i&apos;m</p>
			<h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-blue-300 to-blue-500 bg-clip-text text-transparent">
				mustaeen ahmed
			</h1>
			<div className="flex my-2">
				<div className="flex w-full flex-row items-center gap-x-1 rounded-xl text-white text-sm whitespace-nowrap">
                    <Lanyard />
					&mdash;
					<Time />
				</div>
			...
			<div className="flex items-center justify-center gap-3">
				<a href="/resume.pdf" target="_blank" className="cursor-pointer">
					<svg className="bg-button-color p-2 rounded-lg fill-current text-white hover:text-neutral-400 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 44 44">
				...
				<a href="https://github.com/must108" target="_blank" className="cursor-pointer">
					<div className="bg-button-color p-2 rounded-lg fill-current text-white hover:text-neutral-400 transition-colors duration-300 text-2xl">
						<BsGithub />
					</div>
				</a>
